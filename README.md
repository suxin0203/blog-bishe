...
> 基于 Vue 3 + Express + MySQL 构建的前后端分离博客平台，集成用户认证、内容管理、互动系统、积分商城、数据看板、AI 智能向导及微信小程序扫码登录等完整功能。
...
- 🤖 **AI 智能向导**：站内助手「文文」，Tool Calling 查询真实文章/分类/站点数据，SSE 流式回答 + 多轮会话记忆
...
| **数据看板** | 统计概览、文章排行、用户趋势、流量分析、AI 向导使用统计 |
| **AI 智能向导** | 站内助手「文文」（智谱 GLM）：SSE 流式问答、Tool Calling 查真实文章/分类/标签/站点统计、多轮会话、后台使用统计 |
